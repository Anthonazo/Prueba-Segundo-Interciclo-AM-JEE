...
a persistence unit "PruebaPWPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "PruebaPW/pom.xml":
...
artifact ("PruebaPW.war") is already built. You can build
